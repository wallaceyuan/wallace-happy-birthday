define({
	...
	body:'<div class="swiper-container" id="slider1">\
			<div class="swiper-wrapper">\
				...
				<div class="swiper-slide" id="slideone"><div class="container"><div class="balloon"><div><span>☺</span></div><div><span>B</span></div><div><span>D</span></div><div><span>A</span></div><div><span>Y</span></div><div><span>!</span></div></div><h1>Wallace</h1><div class="cakw"><i><img src="images/cake.png"></i></div></div><svg class="swiper-polyline"><polyline points="0 10,10 2,20 10" stroke="white" stroke-width="3" fill="none"><animate attributename="opacity" from="1" to="0.2" dur="1s" accumulate="none" repeatcount="indefinite"></animate></polyline><polyline points="0 20,10 12,20 20" stroke="white" stroke-width="3" fill="none"><animate attributename="opacity" from="1" to="0.2" dur="1s" accumulate="none" repeatcount="indefinite"></animate></polyline></svg></div>\
				<div class="swiper-slide" id="slidetwo"><div class="container"><div class="left_img"><i><img src="images/bg.png"></i></div><div class="right_inf"><div id="slogan_1">生日快乐</div></div><svg class="swiper-polyline"><polyline points="0 10,10 2,20 10" stroke="white" stroke-width="3" fill="none"><animate attributename="opacity" from="1" to="0.2" dur="1s" accumulate="none" repeatcount="indefinite"></animate></polyline><polyline points="0 20,10 12,20 20" stroke="white" stroke-width="3" fill="none"><animate attributename="opacity" from="1" to="0.2" dur="1s" accumulate="none" repeatcount="indefinite"></animate></polyline></svg></div></div>\
				<div class="swiper-slide"><p><a href="#demo/newpage" class="btn main_btn btn-info">图片</a></p><p><a href="#demo/newpageright" class="btn main_btn btn-info">百科</a></p><p><a href="#" data-panel="demoPanelSidemenu" class="btn main_btn btn-info btn-demo-panel">音乐</a><a href="#" data-panel="demoPanelAlert" class="btn main_btn btn-info btn-demo-panel">提示对话框</a><a href="#" data-panel="demoPanelConfirm" class="btn main_btn btn-info btn-demo-panel">确认对话框</a></p><svg class="swiper-polyline"><polyline points="0 10,10 2,20 10" stroke="white" stroke-width="3" fill="none"><animate attributename="opacity" from="1" to="0.2" dur="1s" accumulate="none" repeatcount="indefinite"></animate></polyline><polyline points="0 20,10 12,20 20" stroke="white" stroke-width="3" fill="none"><animate attributename="opacity" from="1" to="0.2" dur="1s" accumulate="none" repeatcount="indefinite"></animate></polyline></svg></div>\
		  	</div>\
		  </div>\
		 ',
